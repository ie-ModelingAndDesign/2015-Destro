...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        i.image = UIImage(named: "/Users/e145703/Desktop/2015-Destro-master/Sw1/Sw1-1/pc2.eps")
        view.addSubview(i)
    ...
    func sideSwipeAction(gesture: UIGestureRecognizer) {
        if let swipeGesture = gesture as? UISwipeGestureRecognizer {
            ...
            case UISwipeGestureRecognizerDirection.Right:
                ...
                a.image = UIImage(named: "/Users/e145703/Desktop/2015-Destro-master/Sw1/Sw1-1/pc2.eps")
                view.addSubview(a)
                if f == 1{
                    f = 0
                }
